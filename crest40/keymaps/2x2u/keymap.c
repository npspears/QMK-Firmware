...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [0] = LAYOUT_2x2u( \
    ...
    KC_PSCR, KC_LGUI, KC_LALT, KC_GRV, TT(1), LT(2, KC_SPC), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
    ),
  ...
  */
  [1] = LAYOUT_2x2u( \
      ...
      KC_ESC,  CALTDEL,  TSKMGR, _______, _______, _______, KC_NUBS, KC_GRV,  _______, _______
    ),
