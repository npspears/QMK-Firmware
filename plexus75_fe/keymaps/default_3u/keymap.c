...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |-----------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  * |    PRNSCRN    |     LGUI    |     LALT     |    TT(_FN)    |    TT(_FN1)    |     SPACE      |     RALT    |     RGUI     |    CAPS     |
   * '--------------------------------------------------------------------------------------------------------------------------------------'
   */
     [_BASE] = LAYOUT_2x3u(
       KC_EQL,        KC_1,    KC_2,    KC_3,     KC_4,    KC_5,    KC_LBRC,   KC_NLCK,   KC_RBRC,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
       ...
       KC_PSCR, KC_LGUI, KC_LALT, TT(_FN), KC_P1, LT(2, KC_SPC), KC_RALT, KC_CAPS, KC_RGUI
    ),
