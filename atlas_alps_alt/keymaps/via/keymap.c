...
[0] = LAYOUT_all( \
  ...
  RGB_TOG,       KC_LGUI, KC_LALT, TT(1),    LT(2, KC_SPC),    CALTDEL, KC_RALT, KC_CAPS  \
),
...
[1] = LAYOUT_all( \
  ...
  KC_NUBS,  CALTDEL,  TSKMGR, _______, _______, _______, _______, _______ \
),
 ...
 */
[2] = LAYOUT_all( \
  RGB_HUI,  RGB_HUD,  RGB_SAI,  RGB_SAD,  RGB_VAI,  RGB_VAD,  RGB_M_P,  RGB_M_G, RGB_M_SN, RGB_M_K, RGB_MOD, RGB_RMOD,  \
  ...
  RESET,    KC_GRV, _______, _______, _______,  _______,  _______,  _______  \
),
/* 3
 * ,-----------------------------------------------------------------------------------.
 * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  | Bksp |
