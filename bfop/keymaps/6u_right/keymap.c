...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_6u_left(
      ...
      TG(2),   KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_PDOT, KC_P0,    KC_PDOT,  KC__VOLDOWN, MO(1),   KC_LEFT, KC_DOWN,    KC_UP,     KC_RIGHT
    ),
    ...
    [1] = LAYOUT_6u_left(
      ...
      KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_CUT,   KC_PGDN,     KC_P4,    KC_P5,   KC_P6,   KC_PMNS,    KC__VOLUP,   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_COPY,  KC_END,      KC_P1,    KC_P2,   KC_P3,   KC_PENT,    KC__MUTE,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
      KC_TRNS, KC_LCTL, KC_LGUI, KC_LALT, KC_TRNS, KC_P0,   KC_PDOT,  KC__VOLDOWN, KC_SPC,   KC_SPC,  KC_LEFT, KC_DOWN,    KC_UP,       RESET
    ),
