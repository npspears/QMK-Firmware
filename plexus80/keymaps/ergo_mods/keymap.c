...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ergo_mods(
      ...
      KC_LCTL,  KC_MENU, KC_LGUI, KC_LALT,  KC_SPC,  LT(1, KC_SPC), KC_SPC, KC_RALT, KC_RGUI, KC_MENU, KC_RCTL
    ),
    ...
    [1] = LAYOUT_ergo_mods(
        ...
        RESET,   RESET,     TT(2), _______, _______, _______, _______, _______, _______, _______, _______
    ),
