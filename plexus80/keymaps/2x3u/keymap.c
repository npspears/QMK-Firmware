...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_2x3u(
      ...
      KC_LCTL,  KC_LGUI, KC_LALT, LT(2, KC_SPC), RGB_TOG, LT(1, KC_SPC), KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    ...
    [1] = LAYOUT_2x3u(
        ...
        RESET,   RESET,   _______, _______, _______, _______, _______, _______, _______, _______
    ),
