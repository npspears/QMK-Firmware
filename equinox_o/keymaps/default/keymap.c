...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT_default(
        KC_TAB,        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_PGUP,  KC_Y,    KC_U,          KC_I,    KC_O,    KC_P,    KC_DEL,
        CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_PGDN,  KC_H,    KC_J,          KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_END,   KC_N,    KC_M,          KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
